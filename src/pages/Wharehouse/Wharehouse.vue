...
import createFloor from "src/use/wh/floor";
import createWall from "src/use/wh/wall";
// import createZone from "src/use/zone";
import createShelves from "src/use/wh/shelves";

import store from 'src/use/wh/useStore'
...
export default {
  ...
  setup() {
    ...
    //   console.log('box : ', box);
      $q.notify({
          progress: false,
          message: `${shelf.name} - ${box.rowIndex}열 ${box.rowIndex}목록`,
          color: 'primary',
          multiLine: true,
