...
export default {
    ...
    setup(props, context ) {
        ...
        // 옵션 변경시 처리
        // let propOption = props;
        // console.log('propOption : ', propOption.options);
        // watch
        // watch(propOption, ( propOption, prePropOption ) => {
        //     console.log('propOption : ', propOption);
        //     // deep: true
        //     // props.options = {
        //     //     deep: true,
        //     //     handler(newVal) {
        ...
        const hasActiveClass = computed(() => {
            return localOptions.value.some((option) => option.isActive);
        })
            ...
            props.options.forEach((item, index) => {
                ...
                customStyle += `
                    ...
                    transform: translateX(${(index * containerWidth) /
                        ...
                        containerWidth / props.options.length / 4}px);
        ...
        function isActive(button, value = props.value) {
            return (
                button.id == value ||
